...
export const chains: supported_chains = {
  terra2: {
    ...
    multiquery:
      "terra1m277jus3ahphsy6wml8kdwrz2ecf7wy4ggncz6d9xmhd2a29qyss3zakjl",
    multicall:
      "terra1m277jus3ahphsy6wml8kdwrz2ecf7wy4ggncz6d9xmhd2a29qyss3zakjl",
  ...
  juno: {
    ...
    multiquery:
      "juno1q49nd5wyecxc64hmuqr3ax3get0pt337frwjqg0lxx5lagv3vfgsa5quh0",
    multicall:
      "juno1l7vrwvhvfea0wd2ch4qs9u0vrqr0pynxddft70kw0dgjuj0tzvys73hnuc",
    ...
    validators: [
      {
        ...
        logo: "obi",
        delegate_url:
          "https://restake.app/juno/junovaloper14ts0j42qkpr43a3tgxr7zz6l6zdf7hdethuxxd",
      },
    ],
  },
  "juno-testnet": {
    ...
    validators: [
      {
        ...
        logo: "obi",
        delegate_url:
          "https://sei.explorers.guru/validator/seivaloper1hgateul87eemqyvcjszlkdxm8welsf5v07cukp",
      },
      {
        name: "PFC",
        logo: "pfc",
        delegate_url:
          "https://sei.explorers.guru/validator/seivaloper1w48csxj6xrhs99wz4uhys6ukdkegcn8haq9xpw",
      },
    ],
  },
  joe: {
    denom: "ujoe",
    rpc: "https://joe-rpc.polkachu.com",
    api: "https://joe-api.polkachu.com",
    chain: "joe-1",
    name: "Jøe",
