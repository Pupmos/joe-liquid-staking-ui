import {Box, Flex, Text, Button, useDisclosure, Input, FormLabel} from "@chakra-ui/react";
...
function addValidatorMsg(address: string, hub: string, valoper: string): EncodeObject[] {
...
function removeValidatorMsg(address: string, hub: string, valoper: string): EncodeObject[] {
    const messages: EncodeObject[] = [];
